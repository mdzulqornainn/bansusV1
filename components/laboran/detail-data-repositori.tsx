...
interface DetailDataRepositoriLaboranPageProps {
...
const DetailDataRepositoriLaboranPage = ({
  dataRepositori,
}: DetailDataRepositoriLaboranPageProps) => {
  return (
    <div className="min-h-screen p-6 lg:ml-48">
      ...
      <div className={theme.card_max_4}>
        <div className={theme.card_default}>
          ...
          <p className={`text-sm ${theme.text_default} mt-1 font-bold`}>
            {dataRepositori?.status}
          </p>
...
export default DetailDataRepositoriLaboranPage;
