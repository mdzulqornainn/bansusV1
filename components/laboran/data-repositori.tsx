...
interface DataRepositoriLaboranPageProps {
...
const DataRepositoriLaboranPage = ({
  dataRepositori,
}: DataRepositoriLaboranPageProps) => {
                ...
                <tr key={item.id} className="hover:bg-gray-800/30">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex justify-center gap-6">
                      <Link
                        href={`/laboran/kelola-repositori/detail/${item.id}`}
                      >
                        <ButtonIcon title="Detail" icon={<Info size={18} />} />
                      </Link>
                      <Link href={`/laboran/kelola-repositori/edit/${item.id}`}>
...
export default DataRepositoriLaboranPage;
