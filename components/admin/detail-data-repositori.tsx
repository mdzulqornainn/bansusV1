...
interface DetailDataRepositoriAdminPageProps {
...
const DetailDataRepositoriAdminPage = ({
  dataRepositori,
}: DetailDataRepositoriAdminPageProps) => {
  return (
...
export default DetailDataRepositoriAdminPage;
