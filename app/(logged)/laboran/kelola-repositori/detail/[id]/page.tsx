import DetailDataRepositoriLaboranPage from "@/components/laboran/detail-data-repositori";
...
export default async function Page({ params }: PageProps) {
  ...
  return <DetailDataRepositoriLaboranPage dataRepositori={dataRepositori} />;
}
